...
func resolveNameHandler(cliCtx context.Context, storeName string) http.HandlerFunc {
...
func whoIsHandler(cliCtx context.Context, storeName string) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		vars := mux.Vars(r)
		paramType := vars[restName]
...
func namesHandler(cliCtx context.Context, storeName string) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
